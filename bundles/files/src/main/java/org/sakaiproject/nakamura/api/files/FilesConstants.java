...
public interface FilesConstants {
   ...
   */
  public static final String POOLED_CONTENT_NT = "sakai:pooledcontent";
  /**
   * The jcr:primaryType for the pooled content members nodetype.
   */
  public static final String POOLED_CONTENT_MEMBERS_NT = "sakai:pooledcontentmembers";
  /**
   * The name for the pooled content members node.
   */
  public static final String POOLED_CONTENT_MEMBERS_NODENAME = "members";

  /**
   * The name for the managers property on the pooled content members node.
   */
  public static final String POOLED_CONTENT_MEMBERS_MANAGERS = "sakai:managers";
  /**
   * The name for the viewers property on the pooled content members node.
   */
  public static final String POOLED_CONTENT_MEMBERS_VIEWERS = "sakai:viewers";
  /**
   * The name of the property that holds the filename.
   */
  public static final String POOLED_CONTENT_FILENAME = "sakai:pool-file-name";
}
